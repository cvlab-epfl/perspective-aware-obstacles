...
REPLACEMENTS = {
	'02_loc1_obstacles': 'snowstorm1',
	'03_loc1_obstacles2': 'snowstorm2',
}
...
def main(src_dir, dest_dir, cmd, ext, concurrent):
	...
	src_files = list(src_dir.glob('**/*.jpg'))
	dest_files = [dest_dir / rename(p.relative_to(src_dir)) for p in src_files]
