...
def image_grid(imgs, num_cols=2, downsample=1, captions=None, caption_color=(200, 128, 0)):
	...
	for idx, img in enumerate(imgs):
		...
		if img is not None:
			...
			if captions is not None and captions[idx]:
				...
				img = img.copy()
				# shadow
				cv.putText(img, caption, (18, 50), cv.FONT_HERSHEY_DUPLEX, 2, color=(0, 0, 0), thickness=4)
				# foreground
				cv.putText(img, caption, (18, 50), cv.FONT_HERSHEY_DUPLEX, 2, color=caption_color, thickness=2)
